                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                        ...
                                        <div class="input-group input-group-alternative mb-3">
                                            <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" type="text" name="name" value="{{ $train->name }}" required autofocus>
                                        </div>
                                        @if ($errors->has('name'))
                                    ...
                                    <div class="form-group{{ $errors->has('isAvailable') ? ' has-danger' : '' }}">
                                        ...
                                        <div class="input-group input-group-alternative mb-3">
                                            ...
                                            <select class="form-control{{ $errors->has('isAvailable') ? ' is-invalid' : '' }}" name="isAvailable">
                                                @if ($train->isAvailable == "Not available")
                                                    <option value="{{$train->isAvailable}}">{{$train->isAvailable}}</option>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('location') ? ' has-danger' : '' }}">
                                        ...
                                        <div class="input-group input-group-alternative mb-3">
                                            <input class="form-control{{ $errors->has('location') ? ' is-invalid' : '' }}" type="text" name="location" value="{{ $train->location }}" required autofocus>
                                        </div>
